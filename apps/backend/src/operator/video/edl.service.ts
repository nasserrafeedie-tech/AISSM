...
const CRAFT_RULES = [
  ...
  '   starts. Fast pace correlates with people finishing the video. This means',
  '   MANY short segments, not a few long ones — a good 30-second reel is often',
  '   8-12 cuts. A reel of only 2-3 segments is almost always too sparse.',
