...
export const FOUNDER_NOTE: readonly string[] = [
  ...
  'Social media for a business shouldn’t be a second full-time job, so we built the partner that I wished existed for her. One that you can just text, then get back to the work you love.',
] as const;
